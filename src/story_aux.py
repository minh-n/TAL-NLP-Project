...
class Environment:
	def __init__(self):	
		...
		self.rooms.append(Room("Antoine's bedroom"))

		self.rooms.append(Room("Laura's bedroom"))

		self.rooms.append(Room("Maria's bedroom"))
		self.rooms[-1].inventory.entertainments.append(Entertainment("CRT_TV", 1))

		self.rooms.append(Room("Annie's bedroom"))

		self.rooms.append(Room("Jeffery's bedroom"))
