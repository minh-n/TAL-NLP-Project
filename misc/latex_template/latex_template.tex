...
\title{\LARGE Projet TAL - Compte-rendu}
\author{Adrien LAVILLONNIERE - Corentin MANSCOUR - Hien Minh NGUYEN}
\date{5 mai 2018}
\maketitle
...
\linebreak \linebreak
	...
	\\
	\\
\includegraphics[width=300pt]{lm.jpg} % width=\linewidth to get image to fill whole width
\\
\linebreak 
...
\subsection{Test}
	Lorem ipsumipsumipsumipsumipsum
